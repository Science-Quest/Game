  ...
  return (
    <div id="result-page" className="relative h-[100vh] w-[100vw] text-light">
        ...
        <div className="flex flex-col mt-4 gap-y-8 w-full">
          <div className="flex flex-row w-full justify-between">
            <button
              ...
              className="flex flex-row bg-primary rounded-lg px-6 py-4 gap-x-4"
            >
          ...
          <button
            className="mx-auto flex flex-row bg-primary rounded-lg px-6 py-4 gap-x-4"
            onClick={() =>
      ...
      <div
        ...
        className="absolute z-10 top-0 left-0 bg-black opacity-35 w-full h-full"
      ></div>
    </div>
  );
}
